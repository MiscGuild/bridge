                    ...
                    fetch(
                        ...
                        .then((data) => {
                            ...
                            if (data.success === true && data.player === null) {
                                ...
                                bot.executeCommand(
                                    `/gc ${_playerName}, the player ${_playerName} was not found. | ${getRandomHexColor()}`
                                );
                            ...
                            bot.executeCommand(
                                `/gc [CVC-DEFUSAL] IGN: ${_playerName} | KILLS: ${_kills} | WINS: ${_wins} | KDR: ${_kdr.toFixed(
                                    2
                                )} | HEADSHOT KILLS: ${_headshots} | WLR: ${_wlr.toFixed(
                                    2
                                )} | ${getRandomHexColor()}`
                            );
            ...
            return new Promise((resolve, reject) => {
                fetch(
                    ...
                    .then((data) => {
                        ...
                        console.log(
                            `[DEBUG-DEFUSAL] ${_playerName} is checking the stats of ${_target} and succeeded`
                        );

                        bot.executeCommand(
                            `/gc [CVC-DEFUSAL] IGN: ${_target} | KILLS: ${_kills} | WINS: ${_wins} | KDR: ${_kdr.toFixed(
                                2
                            )} | HEADSHOT KILLS: ${_headshots} | BOMBS PLANTED: ${_bombs} | ${getRandomHexColor()}`
                        );
