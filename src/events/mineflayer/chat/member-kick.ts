...
export default {
    ...
    run: async (
        ...
        console.log(`[DEBUG] ${playerName} was kicked by ${kickedByPlayerName}. Trying to log this...`);
        ...
        .then((data) => {
            ...
            if (isFetchError(mojangProfile)) {
                ...
                console.log(`[DEBUG] ${playerName} left the guild, successfully logged this event.`);
                return resolve();
            }
        })
    })
