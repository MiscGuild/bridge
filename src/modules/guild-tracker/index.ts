...
export async function trackGuildEvent(event: ParsedChatEvent, bridge: Bridge): Promise<void> {
    switch (event.type) {
...
export async function syncGuildMembers(bridge: Bridge): Promise<void> {
    try {
